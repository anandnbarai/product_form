...
<body>
    <div class="container-fluid mt-3">
        <button type="submit" name="view" class="bg-primary text-white border-0 p-1"><a
                href="addProduct.php">&nbsp;&nbsp;&nbsp;Add Product&nbsp;&nbsp;&nbsp;</a></button>
    </div>
    ...
    <form method="post" class="mt-3">
        <div class="container">
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="vCustomerName" id="vCustomerName" class="form-control"
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="number" name="iDiscount" id="iDiscount" class="form-control" placeholder="Enter Discount"
                    autocomplete="off" required>
            </div>
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="product_title" class="form-label">Quantity :</label>
                <input type="number" name="iQty" id="iQty" class="form-control" placeholder="Enter Quantity"
                    autocomplete="off" required>
            </div>
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="product_title" class="form-label">Net Amount :</label>
                <input type="text" name="iNetAmount" id="iNetAmount" placeholder="Rate – Disc Of Rate"
                    class="form-control" autocomplete="off" readonly>
            </div>
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="product_title" class="form-label">Total Amount :</label>
                <input type="text" name="iTotalAmount" id="iTotalAmount" class="form-control"
                    placeholder="Net Amount * Qty" autocomplete="off" readonly>
            </div>
            <div class="form-outline mb-4 w-50 m-auto">
                <input type="button" name="AddData" id="addData" class="bg-primary text-white border-0 p-1"
                    value="    Add    ">
            </div>
        </div>
    </form>
    ...
    <div class="form-outline mb-4 w-50 m-auto">
        <input type="button" name="insertData" id="insertData" class="bg-primary text-white border-0 p-1"
            value="    Submit    ">
    </div>
</body>
...
<script>
    $(document).ready(function () {
        ...
        $('#iDiscount').change(function () {
            ...
            const iDiscount = $(this).val();
            const iNetAmount = iPrice - (iDiscount / 100) * iPrice;
        ...
        $('#iQty').change(function () {
            ...
            // Calculate the net amount
            const iNetAmount = $('#iNetAmount').val();
            const iQty = $(this).val();
        ...
        $('#addData').click(function () {
            ...
            newRow.append(`<td><input type="text" class="form-control" id="ProductName" value="${formData.vProductName}" readonly/></td>`);
            newRow.append(`<td><input type="number" class="form-control" id="ProductPrice" value="${formData.iPrice}" readonly/></td>`);
            newRow.append(`<td><input type="number" class="form-control" id="ProductUnit" value="${formData.iUnit}" readonly/></td>`);
            newRow.append(`<td><input type="number" class="form-control" id="iDiscountedPrice" value="${formData.iDiscount}" readonly/></td>`);
            newRow.append(`<td><input type="number" class="form-control" id="ProductQty" value="${formData.iQty}" readonly/></td>`);
            newRow.append(`<td><input type="number" class="form-control" id="ProductNetAmount" value="${formData.iNetAmount}" readonly/></td>`);
            newRow.append(`<td><input type="number" class="form-control" id="ProductTotalAmount" value="${formData.iTotalAmount}" readonly/></td>`);
            newRow.append(`<td><button class="bg-danger text-white border-0 p-1" id="removeAllButton">&nbsp;&nbsp;Remove&nbsp;&nbsp;</button></td>`);
        ...
        $('#tableBody').on('click', '#removeAllButton', function () {
